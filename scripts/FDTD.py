...
class FDTD(object):
    ...
    def load_param(self, directory_="./", filename="param"):
        ...
        param.mx, param.my, param.mz, param.pmlx, param.pmly, param.pmlz, param.nflux, param.ntime, param.step1, param.step2 = data[
            4:14
        ].astype(
            numpy.int32
        )
    ...
    def memory(self):
        ...
        print(
            "Alloc mem = %g Gb, [%d%%]"
            % (
                1. * dynamic_alloc_memory / Gb,
                int(1. * dynamic_alloc_memory / max_available_RAM * 100),
            )
        )
