    ...
    def build_matrix(self):
        ...
        axye = (
            ...
            - (
                ...
                + 2 * eyy1 * eyy2 * (1. / ezz1 - 1. / ezz2) * w ** 2 / ns21
            )
            / e
            / (e + w) ** 2
        )
        ...
        axyw = (
            ...
            - (
                ...
                + 2 * eyy3 * eyy4 * (1. / ezz3 - 1. / ezz4) * e ** 2 / ns34
            )
            / w
            / (e + w) ** 2
        )
        ...
        ayxn = (
            ...
            - (
                ...
                + 2 * exx3 * exx2 * (1. / ezz3 - 1. / ezz2) * s ** 2 / ew23
            )
            / n
            / (n + s) ** 2
        )
        ...
        ayxs = (
            ...
            - (
                ...
                + 2 * exx1 * exx4 * (1. / ezz1 - 1. / ezz4) * n ** 2 / ew14
            )
            / s
            / (n + s) ** 2
        )
    ...
    def compute_other_fields(self, neffs, Hxs, Hys):
        ...
        for neff, Hx, Hy in zip(neffs, Hxs, Hys):
            ...
            bzxe = (
                (n * ezz1 * ezz2 / eyy1 + s * ezz2 * ezz1 / eyy2)
                * (
                    0.5 * n * ezz4 * ezz3 / eyy4 * (2. / e ** 2 - eyx4 / ezz4 / n / e)
                    + 0.5 * s * ezz3 * ezz4 / eyy3 * (2. / e ** 2 + eyx3 / ezz3 / s / e)
                )
                / ezz4
                / ezz3
                / (n * eyy3 + s * eyy4)
            ...
            bzxw = (
                (-n * ezz4 * ezz3 / eyy4 - s * ezz3 * ezz4 / eyy3)
                * (
                    0.5 * n * ezz1 * ezz2 / eyy1 * (2. / w ** 2 + eyx1 / ezz1 / n / w)
                    + 0.5 * s * ezz2 * ezz1 / eyy2 * (2. / w ** 2 - eyx2 / ezz2 / s / w)
                )
                / ezz4
                / ezz3
                / (n * eyy3 + s * eyy4)
            ...
            bzyn = (
                ...
                * e
                + (ezz3 / exx2 * ezz2 * w + ezz2 / exx3 * ezz3 * e)
                * (
                    0.5 * ezz4 * (2. / n ** 2 + exy1 / ezz1 / n / w) / exx1 * ezz1 * w
                    + 0.5 * ezz1 * (2. / n ** 2 - exy4 / ezz4 / n / e) / exx4 * ezz4 * e
                )
                / ezz3
                / ezz2
                / (w * exx3 + e * exx2)
            ...
            bzys = (
                ...
                * e
                - (ezz4 / exx1 * ezz1 * w + ezz1 / exx4 * ezz4 * e)
                * (
                    0.5 * ezz3 * (2. / s ** 2 - exy2 / ezz2 / s / w) / exx2 * ezz2 * w
                    + 0.5 * ezz2 * (2. / s ** 2 + exy3 / ezz3 / s / e) / exx3 * ezz3 * e
                )
                / ezz3
                / ezz2
                / (w * exx3 + e * exx2)
