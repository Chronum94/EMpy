...
class TransferMatrix(DeviceMatrix):
    ...
    def to_chain(self):
        ...
        return ChainMatrix(
            [
                [1. / self.data[1, 0], -self.data[1, 1] / self.data[1, 0]],
                [
    ...
    def to_transfer(self):
        ...
        return TransferMatrix(
            [
                ...
                [1. / self.data[0, 0], -self.data[0, 1] / self.data[0, 0]],
            ]
        )
    ...
    def CM(self, wl=None):
        ...
        for K, neff, l1, l2 in zip(self.Ks, self.neffs, self.l1s, self.l2s):
            Hs.append(
                composeTMlist(
                    [
                        Line(self.wl, neff, 0., neff, l1).TM(wl),
                        K.TM(wl),
...
class T_CTCRR(Device):
    ...
    def solve(self, wls):
        ...
        self.THRU = (
            ...
            + q ** 2 * t1 * N1bar * (q ** 3 * t2 ** 2 * N2 * Kbar[2] - 1.)
        ) / denom
...
class SWG(Device):
    ...
    pf400_125 = [
        1.477287990868007e-007,
        -1.842388456386622e-003,
        4.750925877259235e+000,
    ]
    pf400_225 = [
        1.255208385485759e-007,
        -1.784557912270417e-003,
        4.737972109281652e+000,
    ]
