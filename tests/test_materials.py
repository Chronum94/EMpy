...
def test_const():
    ...
    assert a.get_rix(1.0)[0] == np.array([test_rix])
...
def test_poly():
    ...
    assert_almost_equal(a.get_rix(1.0)[0], np.array([test_rix]))
...
def test_smcoeffs():
    ...
    assert_almost_equal(a.get_rix(0.5)[0], np.array([test_rix]))
...
def test_func():
    ...
    assert_almost_equal(a.get_rix([1.0, 1.5]), np.array([1.5, 1.5]))
    ...
    assert_almost_equal(b.get_rix([1.0, 1.5]), np.array([2.5, 3.0]))
...
def test_known():
    ...
    assert a.get_rix(test_wl)[0] == np.array([test_rix])
